...
namespace :fake do
  ...
  task :users => :environment do
    attrs = { :username => 'sadams',
              ...
              :email_confirmation => 'sadams@gmail.com',
              :first_name => 'Sam',
              :last_name => 'Adams',
    ...
    attrs = { :username => 'jdaniels',
              ...
              :email_confirmation => 'jdaniels@gmail.com',
              :first_name => 'Jack',
              :last_name => 'Daniels',
    ...
    attrs = { :username => 'jbeam',
              :password => 'welcome',
              :password_confirmation => 'welcome',
              :email => 'jbeam@gmail.com',
              :email_confirmation => 'jbeam@gmail.com',
              :first_name => 'Jim',
              :last_name => 'Beam',
    ...
    attrs = { :username => 'jcuervo',
              :password => 'welcome',
              :password_confirmation => 'welcome',
              :email => 'jcuervo@gmail.com',
              :email_confirmation => 'jcuervo@gmail.com',
              :first_name => 'Jose',
              :last_name => 'Cuervo',
